...
This project deliberately avoids the monolithic trap by separating the [Client SIde or Front End](https://github.com/Benedict-dev161/BibleReact) from the [Data Fetching or Back End](https://github.com/Benedict-dev161/BibleReactBe):
